    ...
    <nav class="bg-blue-500 border-gray-200 dark:bg-gray-900">
      ...
      <div class="container mx-auto p-4">
        <div class="flex flex-wrap items-center">
            <div class="lg:w-5/12 md:w-6/12 sm:w-full">
                <h1 class="text-2xl font-semibold mb-2">Good Morning,{{ Auth::user()->name }}!</h1>
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-3 border-b">
                                <button type="button" class="text-white bg-green-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"><a href="{{ route('books.edit', ['book' =>$book->id])}}">Update</a></button>
                                <button type="button" class="text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"><a href="{{ route('books.destroy',['book' =>$book->id]) }}">Delete</a></button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
